...
export const API = {
    'OpenWeather': {
        'CityWeather': environment.APIBaseUrl + 'data/2.5/weather?id={city}&appid=' + environment.AppId,
        'CityForecast': environment.APIBaseUrl + 'data/2.5/forecast?id={city}&appid=' + environment.AppId,
